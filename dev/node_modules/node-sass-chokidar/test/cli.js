var assert = require('assert'),
  ...
  fixture = path.join.bind(null, __dirname, '..', 'node_modules', 'node-sass', 'test', 'fixtures'),
  customFixture = path.join.bind(null, __dirname, 'fixtures');
...
describe('cli', function() {
  ...
  describe('node-sass < in.scss bro', function() {
    it('should read data from stdin 1', function(done) {
  ...
  describe('node-sass in.scss --output out.css', function() {
    ...
    it('should compile with the --source-map-embed option and no outfile', function(done) {
      var src = customFixture('source-map-embed/index.scss');
      var expectedCss = read(customFixture('source-map-embed/expected.css'), 'utf8').trim().replace(/\r\n/g, '\n');
      var result = '';
      var bin = spawn(cli, [
        src,
        '--source-map-embed',
